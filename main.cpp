...
void show_delta(int a, int b, int c) {
 ...
 map<string, string> passo1 = {{"a", "a"}, {"b", "b²"}, {"c", "c"}};
 map<string, int> passo2 = {{"a", a}, {"b", b}, {"c", c}};
 map<string, int> passo3 = {{"a", a}, {"b", pow(b, 2)}, {"c", c}};
 map<string, int> passo4 = {{"ac", ac}, {"b2", pow(b, 2)}};
 ...
 if(quatro_menos_ac > 0 || quatro_menos_ac == 0){
     cout << "Δ = " << passo4["b2"] << " + " << quatro_menos_ac << endl;
 } else {
     cout << "Δ = " << passo4["b2"] << quatro_menos_ac << endl;
 }
 cout << "Δ = " << delta << endl;
...
void show_x1(int a, int b, int c){
    ...
    map<string, string> passo1 = {{"a", "a"}, {"b", "-b"}};
    map<string, int> passo2 = {{"a", a}, {"b", b}, {"delta_int", delta_int}};
    map<string, int> passo3 = {{"a", a}, {"b", b}, {"delta_int", sqrt(delta_int)}};
    map<string, int> passo4 = {{"a", a}, {"b", b}, {"delta_int", sqrt(delta_int)}};
    map<string, int> passo5 = {{"delta_int", delta_int}};
